    ...
    <div class="logo w1210">
        ...
        <div class="search fl">
            <div class="search_form">
                ...
                <form action="<?=\yii\helpers\Url::to(['list/search'])?>" id="search-border" method="get" class="fl">
                    <input type="text" id="search_content" name="name" class="txt" placeholder="请输入商品关键字" /><input type="submit"  disabled="" id="search" class="btn" value="搜索" />
                </form>
        ...
        <div class="summary">
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    ...
                    <li class="hot"><span>浏览次数：</span><span id="hit"></span><span>次</span></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
                </ul>
                <form action="<?=\yii\helpers\Url::to(['user/add-to-cart'])?>" method="get" class="choose">
                    <ul>
                ...
                <div class="introduce detail_div none">
                    <div class="attr mt15">
                        <ul>
                            ...
                            <li><span>商品编号：</span><?=$row->sn?></li>
                            <li><span>品牌：</span><?=$row->brand_id?></li>
                            <li><span>上架时间：</span><?=date('Y-m-d',$row->create_time)?></li>
                        </ul>
                    </div>
...
<script type="text/javascript">
    ...
    $.getJSON('<?=\yii\helpers\Url::to(['goods-list/hit'])?>',{id:<?=$row->id?>},function (data) {
         $('#hit').html(data);
    })
</script>
</body>
